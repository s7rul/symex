    ...
    match () {
        () => {
            if {
                const CHECK: bool = {
                    const fn check() -> bool {
                        let module_path = "enum_match_impl".as_bytes();
                        if if 15usize > module_path.len() {
                            ...
                            module_path[0usize] == 101u8 && module_path[1usize] == 110u8
                                ...
                                && module_path[12usize] == 109u8
                                && module_path[13usize] == 112u8
                                && module_path[14usize] == 108u8
                ...
                defmt::export::header(
                    &{
                        defmt::export::make_istr({
                            #[link_section = ".defmt.{\"package\":\"armv6-m-examples\",\"tag\":\"defmt_info\",\"data\":\"Ex1 start\",\"disambiguator\":\"12378557682773086049\",\"crate_name\":\"enum_match_impl\"}"]
                            #[export_name = "{\"package\":\"armv6-m-examples\",\"tag\":\"defmt_info\",\"data\":\"Ex1 start\",\"disambiguator\":\"12378557682773086049\",\"crate_name\":\"enum_match_impl\"}"]
        ...
        (arg0) => {
            if {
                ...
                defmt::export::header(
                    &{
                        defmt::export::make_istr({
                            #[link_section = ".defmt.{\"package\":\"armv6-m-examples\",\"tag\":\"defmt_info\",\"data\":\"r: {}\",\"disambiguator\":\"8069176632029287434\",\"crate_name\":\"enum_match_impl\"}"]
                            #[export_name = "{\"package\":\"armv6-m-examples\",\"tag\":\"defmt_info\",\"data\":\"r: {}\",\"disambiguator\":\"8069176632029287434\",\"crate_name\":\"enum_match_impl\"}"]
                            static DEFMT_LOG_STATEMENT: u8 = 0;
                            &DEFMT_LOG_STATEMENT as *const u8 as u16
                        })
                    },
        ...
        (arg0) => {
            if {
                ...
                defmt::export::header(
                    &{
                        defmt::export::make_istr({
                            #[link_section = ".defmt.{\"package\":\"armv6-m-examples\",\"tag\":\"defmt_info\",\"data\":\"r: {}\",\"disambiguator\":\"2479413202080893013\",\"crate_name\":\"enum_match_impl\"}"]
                            #[export_name = "{\"package\":\"armv6-m-examples\",\"tag\":\"defmt_info\",\"data\":\"r: {}\",\"disambiguator\":\"2479413202080893013\",\"crate_name\":\"enum_match_impl\"}"]
                            static DEFMT_LOG_STATEMENT: u8 = 0;
                            &DEFMT_LOG_STATEMENT as *const u8 as u16
                        })
                    },
