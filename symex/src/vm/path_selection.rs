...
//!
//! Currently the only supported strategy is [`DFSPathExploration`] which
//! explores all paths using depth-first search.
...
/// constraint that will be asserted when this path begins executing.
///
